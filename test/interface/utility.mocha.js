...
describe('Utility', function () {
  describe('.getCanonicModuleName', function () {
    ...
    it('should works with all notation', function () {
      ...
      assert(
        Utility.getCanonicModuleName('git+https://github.com/user/pm2-slack.git') === 'pm2-slack',
      );
      ...
      assert(
        Utility.getCanonicModuleName('http://registry.com:12/modules/my-module?test=true') ===
          'my-module',
      );
      assert(
        Utility.getCanonicModuleName('http://registry.com:12/modules/http-my-module?test=true') ===
          'http-my-module',
      );
    });
  });
