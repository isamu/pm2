...
const httpMethodToIgnore = ['options', 'head'];
...
class TracingFeature {
  ...
  init(config) {
    ...
    const serviceName = process.env.OTEL_SERVICE_NAME || this.options.serviceName;
        ...
        getNodeAutoInstrumentations({
          ...
          '@opentelemetry/instrumentation-http': {
            ignoreIncomingRequestHook: (request) => {
              ...
              return this.options.ignoreIncomingPaths.some((matcher) =>
                applyMatcher(matcher, request),
              );
            },
            ignoreOutgoingRequestHook: (request) => {
              ...
              return this.options.ignoreOutgoingUrls.some((matcher) =>
                applyMatcher(matcher, request),
              );
            },
          },
